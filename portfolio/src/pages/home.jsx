...
function Home() {
  ...
  const skills = [
    ...
    { name: 'TypeScript', level: 85, color: 'from-blue-600 to-blue-800', icon: <Terminal className="w-4 h-4" /> },
    { name: 'Tailwind CSS', level: 95, color: 'from-teal-400 to-emerald-600', icon: <Palette className="w-4 h-4" /> },
    { name: 'Node.js', level: 85, color: 'from-green-500 to-emerald-600', icon: <Zap className="w-4 h-4" /> },
    { name: 'Python', level: 60, color: 'from-yellow-500 to-amber-600', icon: <Sparkles className="w-4 h-4" /> },
    { name: 'Laravel', level: 85, color: 'from-red-500 to-pink-600', icon: <Shield className="w-4 h-4" /> },
    { name: 'Next.js', level: 70, color: 'from-gray-200 to-gray-400', icon: <Globe className="w-4 h-4" /> },
    { name: 'MongoDB', level: 80, color: 'from-green-400 to-emerald-500', icon: <Database className="w-4 h-4" /> },
    { name: 'MySQL', level: 85, color: 'from-blue-400 to-cyan-500', icon: <Database className="w-4 h-4" /> },
  ];
  ...
  const projects = [
    ...
    },
    {
      ...
      description: 'Project provides a RESTful API designed for managing various operations of a pharmaceutical system.',
  ...
  return (
    <div className="relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 text-white min-h-screen overflow-hidden">
      ...
      {/* Navigation */}
      <nav className={`fixed top-0 w-full z-50 transition-all duration-500 ${scrollY > 50 ? 'bg-gray-900/90 backdrop-blur-xl shadow-2xl' : 'bg-transparent'}`}>
            ...
            <div className="space-y-8">
              <div className="space-y-6">
                <p className="text-xl text-gray-300 leading-relaxed font-light">
                  I'm a passionate full-stack developer dedicated to creating web applications 
                  that combine beautiful design with powerful functionality. With expertise in 
                  modern web technologies, I bring ideas to life through clean code and innovative solutions.
                </p>
                <p className="text-xl text-gray-300 leading-relaxed font-light">
                  My focus is on building scalable, maintainable applications that provide 
                  exceptional user experiences while solving real-world problems efficiently.
                </p>
              </div>
              
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-6">
                {[
                  { icon: <Cpu className="w-5 h-5" />, text: 'Software Engineer', color: 'from-cyan-500 to-blue-600' },
                  { icon: <Terminal className="w-5 h-5" />, text: 'Full Stack Development', color: 'from-purple-500 to-pink-600' },
                  { icon: <Smartphone className="w-5 h-5" />, text: 'Mobile Development', color: 'from-emerald-500 to-green-600' },
                  { icon: <Cloud className="w-5 h-5" />, text: 'Cloud Solutions', color: 'from-orange-500 to-red-600' },
                ].map((item, index) => (
                  <div
                    key={index}
                ...
                <div className="relative w-full h-full bg-gray-800/30 backdrop-blur-sm rounded-3xl border border-gray-700/50 p-2">
                  <div className="w-full h-full bg-gradient-to-br from-gray-900 to-gray-800 rounded-2xl overflow-hidden">
                    <img
                      ...
                      onError={(e) => {
                        e.target.src = 'https://via.placeholder.com/320x384/0f172a/ffffff?text=Profile';
                      }}
                    />
                  </div>
                </div>
      ...
      {/* Skills Section */}
      <section id="skills" className="relative py-24 bg-gradient-to-b from-gray-900/50 to-gray-800/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 relative inline-block">
              ...
              >
                ...
                >
                  <img
                    ...
                    onError={(e) => {
                      e.target.src = 'https://via.placeholder.com/400x224/0f172a/ffffff?text=Project+Image';
                    }}
                  />
              ...
              {activeProject.images && activeProject.images.length > 0 ? (
                <>
                  <img
                    ...
                    onError={(e) => {
                      e.target.src = 'https://via.placeholder.com/800x600/0f172a/ffffff?text=Image+Not+Found';
                    }}
                  />
                  ...
                  {activeProject.images.length > 1 && (
                    <>
                      ...
                      >
                        <ChevronLeft size={28} className="text-gray-300 group-hover:text-white" />
                      </button>
                      <button
                        onClick={nextImage}
                      ...
                      >
                        <ChevronRight size={28} className="text-gray-300 group-hover:text-white" />
                      </button>
                    </>
                  )}
                </>
                  ...
                  {activeProject.images.map((img, index) => (
                    ...
                    >
                      <img
                        ...
                        onError={(e) => {
                          e.target.src = 'https://via.placeholder.com/80/0f172a/ffffff?text=Thumb';
                        }}
                      />
                    </button>
                  ))}
      ...
      {/* Contact Section */}
      <section id="contact" className="relative py-24 bg-gradient-to-b from-gray-800/50 to-gray-900/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold mb-6 relative inline-block">
            ...
            <div className="space-y-8">
              ...
              <div className="pt-8">
                ...
                <div className="flex gap-6">
                  {[
                    { icon: <Github className="w-6 h-6" />, href: 'https://github.com/YoonusAnees', color: 'hover:bg-gray-700' },
                    { icon: <Linkedin className="w-6 h-6" />, href: 'https://www.linkedin.com/in/yoonus-anees-59b7b2302/', color: 'hover:bg-blue-600' },
                    { icon: <Mail className="w-6 h-6" />, href: 'mailto:yoonusanees2002@gmail.com', color: 'hover:bg-cyan-600' },
                  ].map((social, index) => (
                    <a
                      key={index}
                      href={social.href}
                    ...
                    >
                      <div className={`p-3 rounded-lg bg-gray-700/50 ${social.color} transition-colors duration-300`}>
                        {React.cloneElement(social.icon, { className: 'w-6 h-6 text-white' })}
                      </div>
                    </a>
                  ))}
                </div>
            ...
            <div className="bg-gradient-to-br from-gray-800/30 to-gray-900/30 backdrop-blur-sm p-8 rounded-2xl border border-gray-700/50">
              <form className="space-y-6">
                <div>
                  ...
                  <input
                    type="text"
                    className="w-full px-5 py-4 bg-gray-800/50 border border-gray-700/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-transparent text-white placeholder-gray-500 transition-all duration-300"
                ...
                <div>
                  ...
                  <textarea
                    rows={5}
                    className="w-full px-5 py-4 bg-gray-800/50 border border-gray-700/50 rounded-xl focus:outline-none focus:ring-2 focus:ring-cyan-500/50 focus:border-transparent text-white placeholder-gray-500 resize-none transition-all duration-300"
